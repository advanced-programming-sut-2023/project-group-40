...
public enum Texture {
    ...
    GRASS("grass", "dry", new Image(MapMenu.class.getResource("/textures/.jpg").toString(), true)),
    ...
    BEACH("beach", "water", new Image(MapMenu.class.getResource("/textures/beach5.jpeg").toString(), true) ),
