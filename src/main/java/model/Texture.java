...
public enum Texture {
    ...
    LAND_WITH_PEBBLES("land with pebbles", "dry", new Image(MapMenu.class.getResource("/images/textures/pebbles.jpeg").toString(), true)),
    STONE_BLOCK("stone block", "dry", new Image(MapMenu.class.getResource("/images/textures/stoneBlock.jpeg").toString(), true)),
    ...
    PLAIN("plain", "water", new Image(MapMenu.class.getResource("/images/textures/plane.jpeg").toString(), true)),
