...
public class WeaponFactory extends Building {
    ...
    public WeaponFactory(String name, int height, int width, int hp, int[] cost, int workersRequired, Good material,
                         Good weapon, int produceRate, HashSet<Texture> textures, boolean isIllegal,
