...
public enum Buildings {
    ...
    BIG_STONE_GATEHOUSE("big stone gatehouse", new GateHouse("big stone gatehouse", 4, 4, 2000, new int[]{0, 0, 20, 0, 0}, 10, new HashSet<>(), false, BuildingGroups.CASTLE)),
    ...
    KILLING_PIT("killing pit", new KillingPit("killing pit", 2, 3, 0, new int[]{0, 6, 0, 0, 0}, 10, new HashSet<>(), false, BuildingGroups.CASTLE)),
    INN("inn", new Inn("inn", 5, 3, 300, new int[]{100, 20, 0, 0, 0}, 1, new HashSet<>(), false, BuildingGroups.FOOD_PROCESSING)),
    MILL("mill", new FoodProcessing("mill", 2, 2, 300, new int[]{0, 20, 0, 0, 0}, 3, Good.FLOUR, Good.WHEAT, 15, new HashSet<>(), false, BuildingGroups.FOOD_PROCESSING)),
    IRON_MINE("iron mine", new Mine("iron mine", 4, 4, 100, new int[]{0, 20, 0, 0, 0}, 2, Good.IRON, 20, new HashSet<>(List.of(Texture.IRON)), true, BuildingGroups.INDUSTRY)),
    SHOP("shop", new Building("shop", 6, 6, 300, new int[]{0, 5, 0, 0, 0}, 1, new HashSet<>(), false, BuildingGroups.INDUSTRY)),
    ...
    CATHEDRAL("cathedral", new Church("cathedral", 4, 6, 1200, new int[]{1000, 0, 0, 0, 0}, new HashSet<>(), false, BuildingGroups.TOWN_BUILDING, 4)),
    ARMOURER("armourer", new WeaponFactory("armourer", 3, 3, 300, new int[]{100, 20, 0, 0, 0}, 1, Good.IRON, Good.ARMOR, 30, new HashSet<>(), false, BuildingGroups.WEAPON)),
    BLACKSMITH("black smith", new WeaponFactory("black smith", 3, 3, 300, new int[]{100, 20, 0, 0, 0}, 1, Good.IRON, Good.SWORD, 20, new HashSet<>(), false, BuildingGroups.WEAPON)),
    FLETCHER("fletcher", new WeaponFactory("fletcher", 3, 3, 300, new int[]{100, 20, 0, 0, 0}, 1, Good.WOOD, Good.BOW, 40, new HashSet<>(), false, BuildingGroups.WEAPON)),
    POLE_TURNER("pole turner", new WeaponFactory("pole turner", 3, 3, 300, new int[]{100, 10, 0, 0, 0}, 1, Good.WOOD, Good.SPEAR, 20, new HashSet<>(), false, BuildingGroups.WEAPON)),
    OIL_SMELTER("oil smelter", new OilSmelter("oil smelter", 3, 3, 300, new int[]{100, 0, 0, 10, 0}, 1, 20, new HashSet<>(), false, BuildingGroups.CASTLE)),
    PITCH_DITCH("pitch ditch", new Mine("pitch ditch", 1, 2, 300, new int[]{100, 0, 0, 0, 2}, 0, Good.PITCH, 10, new HashSet<>(), false, BuildingGroups.CASTLE)),
    CAGED_WAR_DOGS("caged war dogs", new CagedWarDogs("caged war dogs", 3, 2, 100, new int[]{100, 10, 0, 0, 0}, new HashSet<>(), false, BuildingGroups.CASTLE)),
    //SIEGE_TENT("siege tent", new Building("siege tent", 2,2,100, new int[]{0,0,0,0,0}, new HashSet<>(), false, BuildingGroups.CASTLE)),
    // چادر محاصره
    STABLE("stable", new Building("stable", 4, 2, 300, new int[]{400, 20, 0, 0, 0}, new HashSet<>(), false, BuildingGroups.CASTLE)),
    APPLE_ORCHARD("apple orchard", new FoodProcessing("apple orchard", 3, 3, 100, new int[]{0, 5, 0, 0, 0}, 1, null, Good.APPLE, 20, new HashSet<>(List.of(Texture.GRASS, Texture.DENSE_GRASS_LAND)), true, BuildingGroups.FARM)),
    DIARY_FARMER("diary farmer", new FoodProcessing("diary farmer", 3, 3, 100, new int[]{0, 10, 0, 0, 0}, 1, null, Good.CHEESE, 25, new HashSet<>(List.of(Texture.GRASS, Texture.DENSE_GRASS_LAND)), true, BuildingGroups.FARM)),
