...
public class TextFieldController {
    ...
    public static void checkEmail(HBox emailHBox, TextField email) {
        ...
        } else if (!UserController.checkEmailFormat(email.getText())) {
            successful = false;
            Errors.EMAIL_ERROR.getErrorLabel().setText("email format incorrect!");
            if (emailHBox.getChildren().size() == 2)
                emailHBox.getChildren().add(Errors.EMAIL_ERROR.getErrorLabel());
    ...
    public static void checkPassword(HBox newPasswordHBox, TextField newPassword, HBox oldPasswordHBox,
    ...
    public static void checkSecurityEmpty(ComboBox<String> securityQuestions, HBox securityQuestionsHBox,
